...
export const ProfileChat = ({ navigation: { navigate }, route }: any) => {
        ...
        <View style={tw`bg-gray-900 h-full`}>
            <View style={tw`flex pt-14`}>
                ...
                <View style={tw`flex items-center justify-center mt-10`}>
                    ...
                    />
                    <Text style={[tw`text-4xl text-white mt-3`, { fontFamily: "Poppins_700Bold" }]}>Alexis</Text>
                    <Text style={[tw`text-xl text-white`, { fontFamily: "Poppins_600SemiBold" }]}>Desarrollador web</Text>
                </View>
            </View>
        </View>
    )
