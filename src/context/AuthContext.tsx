...
export const AuthProvider = ({ children }:AuthProviderProps) => {
  ...
  const [authUrl, setAuthUrl] = useState('https://6176-2806-2f0-9f00-ffaf-3431-b3bc-8c09-3d60.ngrok-free.app/api');
  const [baseUrl, setBaseUrl] = useState('https://6176-2806-2f0-9f00-ffaf-3431-b3bc-8c09-3d60.ngrok-free.app/api/v1');
