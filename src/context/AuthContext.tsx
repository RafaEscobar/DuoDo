...
export const AuthProvider = ({ children }:AuthProviderProps) => {
  ...
  //  const [authUrl, setAuthUrl] = useState('https://552e-2806-2f0-9f00-ffaf-c9c7-1705-9b10-72ef.ngrok-free.app/api');
  //  const [baseUrl, setBaseUrl] = useState('https://552e-2806-2f0-9f00-ffaf-c9c7-1705-9b10-72ef.ngrok-free.app/api/v1');
